  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      <div className="text-center mb-12">
        <h1 className="text-3xl font-bold mb-4">무료 MBTI 테스트</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-2">MBTI 유형 검사</h2>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-2">MBTI 유형 이해</h2>
          <p className="text-gray-600 mb-4">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="text-gray-600 mb-4">
            팀 내에서 자신과 동료들의 MBTI을 이해하고 협력할 수 있는 방법을
            배워보세요.
          </p>
        </div>
      </div>
